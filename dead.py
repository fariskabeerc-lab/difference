...
data = {
    "Branch": [
        ...
        "BLUE PEARL", "TAYTAY", "SALEM MALL", "OUD MEHTA", "SUPERSTORE"
    ],
    "2023 Total Sales": [
    ...
    "DIFFERENCE Total Sales": [
        ...
        423250.50, 626003.54, 1769670.58, 5068321.02, 9789990.97
    ]
}

df = pd.DataFrame(data)

# --- Sidebar Filter (No All Branches) ---
selected_branch = st.sidebar.selectbox("Select Branch", df["Branch"].tolist())
